...
2. СТРУКТУРА:
   • ЗАГОЛОВОК-ХУК (1 СТРОКА) — ПИШИ ЗАГЛАВНЫМИ БУКВАМИ, БЕЗ ЭМОДЗИ
...
4. ФОРМАТ ВЫВОДА: только готовый пост. БЕЗ Markdown, БЕЗ **жирного**, БЕЗ _курсива_, БЕЗ эмодзи. Только чистый текст.
